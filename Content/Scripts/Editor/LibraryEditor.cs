...
public class LibraryEditor : Editor
{
    ...
    public override VisualElement CreateInspectorGUI()
    {
        ...
        if (document == null)
        {
            ...
            document = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(filePath.Replace($"{typeof(LibraryEditor)}.cs", documentRelativePath));
            sectionDocument = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(filePath.Replace($"{typeof(LibraryEditor)}.cs", sectionRelativePath));
            elementDocument = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(filePath.Replace($"{typeof(LibraryEditor)}.cs", elementRelativePath));
        }
